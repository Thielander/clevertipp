    ...
    <div class="row bg-light m-0 p-md-4 p-3 border-top rounded-bottom g-md-5">
        ...
        <div class="col-md-6 my-2">
            <h3 class="text-muted fw-light lh-lg d-flex align-items-center">
                <x-orchid-icon path="bs.trophy-fill"/>

                <span class="ms-3 text-dark">{{ __('Profit enquiry') }}</span>
            </h3>
        ...
        <div class="col-md-6 my-2">
            <h3 class="text-muted fw-light lh-lg d-flex align-items-center">
                <x-orchid-icon path="bs.grid-3x2-gap"/>

                <span class="ms-3 text-dark">{{ __('Distance analysis') }}</span>
            </h3>
            <p class="ms-md-5 ps-md-1">
        ...
        <div class="col-md-6 my-2">
            <h3 class="text-muted fw-light lh-lg d-flex align-items-center">
                <x-orchid-icon path="bs.graph-up"/>

                <span class="ms-3 text-dark">{{ __('Combinations') }}</span>
            </h3>
            <p class="ms-md-5 ps-md-1">
        ...
        <div class="col-md-6 my-2">
            <h3 class="text-muted fw-light lh-lg d-flex align-items-center">
                <x-orchid-icon path="bs.bar-chart-fill"/>

                <span class="ms-3 text-dark">{{ __('Statistics') }}</span>
            </h3>
            <p class="ms-md-5 ps-md-1">
